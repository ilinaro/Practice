...
function template(item) {
  ...
  newElement.innerHTML = `<a class="search__finding-link target="_blank">${item.full_name}</a>`;
  const newSpan = newElement.appendChild(document.createElement('span'));  
  newSpan.classList.add('search__finding-description');
  newSpan.innerHTML = `${item.description}`;
